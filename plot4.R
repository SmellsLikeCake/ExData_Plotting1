...
par(mfrow = c(2, 2))
plot(data3$datetimes, data3$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
plot(data3$datetimes, data3$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(data3$datetimes, data3$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()